# Initial version was taken from https://github.com/huggingface/transformers
...
@registry.register_encoder("albef_bert_encoder")
class AlbefBertEncoder(Encoder):
    @dataclass
    class Config(Encoder.Config):
        name: str = "albef_bert_encoder"
        bert_model_name: str = "bert-base-uncased"
        bert_config_path: str = "mmf/models/albef/configs/config_bert.json"

    def __init__(self, config: Config, *args, **kwargs):
        super().__init__()
        self.config = config.get("params", {})
        bert_config = BertConfig.from_json_file(self.config.bert_config_path)
        self.module = BertModel.from_pretrained(self.config.bert_model_name, config=bert_config, add_pooling_layer=False)
